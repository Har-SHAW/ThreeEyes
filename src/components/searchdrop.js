...
class Sdrop extends Component {
    ...
    render() {
        ...
        return (<div style={
            ...
            <Select isDisabled={
                    this.state.disabled || this.state.distDisable
                }
                onChange={
                    (val) => {
                    ...
                    onClick={
                        () => {
                            if (this.state.state === null || this.state.dist === null || this.state.PsRegion === "") {
                                this.setState({status: "Select a valid information!", isStatus: true});
                            } else {
                                this.setState({disabled: true, status: null, isStatus: false});
